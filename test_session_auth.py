...
def test_session_auth():
    ...
    test_endpoints = [
        ...
        {"method": "PATCH", "url": f"{base_url}/clubs/1/status", "name": "동아리 모집상태 변경"},
        
        # 지원서 관리 API
        {"method": "GET", "url": f"{base_url}/applications?club_id=1", "name": "지원자 목록 조회"},
        {"method": "GET", "url": f"{base_url}/applications/1", "name": "지원서 상세 조회"},
        {"method": "POST", "url": f"{base_url}/members", "name": "동아리원 등록"},
        
        # 공지 관리 API
        {"method": "POST", "url": f"{base_url}/clubs/1/notices", "name": "동아리 공지 등록"},
        {"method": "PATCH", "url": f"{base_url}/clubs/1/notices/1", "name": "동아리 공지 수정"},
        {"method": "DELETE", "url": f"{base_url}/clubs/1/notices/1", "name": "동아리 공지 삭제"},
        
        # 배너 관리 API
        {"method": "POST", "url": f"{base_url}/banners/", "name": "배너 등록"},
        {"method": "PATCH", "url": f"{base_url}/banners/1/status", "name": "배너 상태 변경"},
