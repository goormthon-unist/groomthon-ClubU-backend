...
class ReservationController(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # 필수 필드 검증
            required_fields = ['club_id', 'user_id', 'room_id', 'date', 'start_time', 'end_time']
    ...
    @reservation_ns.param('mine', '내 예약만 조회 (true/false)', type=bool, default=True)
    @reservation_ns.param('status', '상태 필터 (CONFIRMED,CLEANING_REQUIRED,CLEANING_DONE)', type=str)
